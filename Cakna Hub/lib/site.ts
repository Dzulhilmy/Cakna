...
export type Story = {
  ...
  images?: string[]; // gallery shown when the story is opened
};
...
export type SectionLayout = "text" | "imageText" | "gallery";

/**
 * An admin-created section that can be added to any public page (CRUD).
 * `images` holds one or more uploaded/library images.
 */
...
export type SiteContent = {
  ...
  hero: {
    ...
    heading: string;
    subtext: string;
    bgImages: string[]; // optional background images (slides)
  ...
  about: {
    ...
    quote: string;
    quoteSub: string;
    quoteBgImages: string[]; // optional background images for the quote card
...
export const defaultSiteContent: SiteContent = {
  ...
  setemPage: {
    ...
    gapStats: [
      {
        value: "40%",
        label: "Students experience math anxiety, affecting their performance.",
      },
      {
        value: "Low Proficiency",
        label: "Many primary school students struggle with basic arithmetic.",
      },
      {
        value: "PISA 2018",
        label:
          "Malaysia ranked below the international average in math performance.",
      },
    ],
    ...
    audience: [
      {
        title: "Students",
        desc: "Primary and secondary school students struggling with basic math.",
      },
      {
        title: "Those with Anxiety",
        desc: "Anyone experiencing anxiety or a phobia towards mathematics.",
      },
      {
        title: "Parents",
        desc: "Parents who want to understand math therapy methods for their children.",
      },
    ],
    ...
    steps: [
      {
        ...
        desc: "Provide basic details about your school and interest in SETEM.",
      },
      {
        title: "Confirmation & Follow-Up",
        desc: "Our team will review your submission and follow up.",
      },
      {
        title: "Program Discussion",
        desc: "We discuss the program schedule based on your school's needs.",
      },
      {
        title: "Final Confirmation",
        desc: "Confirm the date, logistics, and requirements for smooth execution.",
      },
      {
        title: "SETEM Begins!",
        desc: "Get ready for an impactful math experience at your school!",
      },
    ],
    ctaHeading: "Ready to Get Started?",
    ctaText:
      "Bring SETEM to your school or institution and give every child the opportunity to excel in mathematics.",
    ctaLabel: "Contact Us",
    ctaHref: "#hubungi",
  },
  csrPage: {
    ...
    stories: [
      {
        ...
        date: "March 25, 2025",
        category: "CSR Franchisee",
        excerpt:
          "At HOME Tanjung Minyak, education is just one part of the bigger picture. This centre is making waves with their heartfelt initiatives across the community.",
      },
      {
        title: "Creating a Kinder, Greener HOME at Klebang Besar",
        date: "March 25, 2025",
        category: "CSR Franchisee",
        excerpt:
          "At HOME Klebang Besar, everyday actions reflect a deeper commitment to both the environment and people. The team implements smart waste separation and more.",
      },
      {
        title: "Everyday Sustainability at HOME Semenyih Ecohill",
        date: "March 25, 2025",
        category: "CSR Franchisee",
        excerpt:
          "At HOME Semenyih Ecohill, going green is more than just a trend — it's a way of life. The centre actively embraces eco-friendly practices every day.",
      },
      {
        title: "A Small Act of Care at HOME Shah Alam Seksyen 9A",
        date: "March 25, 2025",
        category: "CSR Franchisee",
        excerpt:
          "At HOME Shah Alam Seksyen 9, a simple gesture is making a meaningful difference. The team has introduced a thoughtful routine to support their community.",
      },
      {
        title: "Sustainable Steps at HOME Klang Bandar Puteri",
        date: "March 25, 2025",
        category: "CSR Franchisee",
        excerpt:
          "At HOME Klang Bandar Puteri, sustainability isn't just a goal — it's a daily habit. The centre takes simple but impactful actions to reduce waste.",
      },
      {
        title:
          "HOME Bandar Perda Champions 3R: Small Steps Towards a Greener Future",
        date: "March 22, 2025",
        category: "CSR Franchisee",
        excerpt:
          "At HOME Bandar Perda, sustainability isn't a campaign — it's a classroom culture. The centre integrates the 3R concept: Reduce, Reuse, Recycle.",
      },
    ],
    ctaHeading: "Want to Make a Difference?",
    ctaText:
      "Join our network of franchisees and start creating impact in your own community.",
    ctaLabel: "Join Us",
    ctaHref: "/register",
  },
  ...
  docs: {
    policy: {
      ...
      content:
        "Dokumen ini menggariskan polisi rasmi HOME CAKNA yang terpakai kepada seluruh pasukan, subsidiari, francaisi dan pihak luar.\n\nSemua pihak yang terlibat dengan HOME CAKNA dikehendaki mematuhi polisi yang ditetapkan dalam dokumen ini.",
      lastUpdated: "2026",
    },
    sop: {
    ...
    guidelines: {
      ...
      content:
        "Garis panduan ini disediakan untuk membantu semua pihak memahami cara yang betul dalam melaksanakan program HOME CAKNA.\n\nIa merangkumi panduan berkaitan komunikasi, pelaporan, dokumentasi dan pematuhan kepada standard CAKNA.",
      lastUpdated: "2026",
    },
    manual: {
      title: "Manual",
      ...
      content:
        "Manual ini menyediakan panduan lengkap tentang penggunaan sistem Cakna Hub, termasuk cara mendaftar, menghantar laporan program, memohon pembiayaan dan mengurus maklumat francaisi.\n\nSila hubungi pasukan sokongan jika memerlukan bantuan tambahan.",
      lastUpdated: "2026",
    },
  },
};
