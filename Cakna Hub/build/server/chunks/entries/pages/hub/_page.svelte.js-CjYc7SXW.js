import { ak as head, ah as attr, ai as stringify, a5 as escape_html, a6 as sanitize_props, af as spread_props, ad as slot, Q as derived } from '../../../chunks/index.js-6hyNTq_g.js';
import { r as roleLabel } from '../../../chunks/types.js-D6PGEaQi.js';
import { B as Bell } from '../../../chunks/bell.js-F3vkrYsw.js';
import { I as Icon } from '../../../chunks/Icon.js-VGojmkFT.js';
import { U as Users } from '../../../chunks/users.js-DL1xGtlE.js';
...
function Hub($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<main class="relative mx-auto flex min-h-screen max-w-4xl flex-col justify-center px-6 py-16"><div class="absolute inset-x-0 top-0 flex items-center justify-end gap-4 p-6"><a href="/notifications" title="Announcements" class="text-zinc-400 transition-colors hover:text-rose-500">`);
    Bell($$renderer2, { size: 18, strokeWidth: 1.75 });
    $$renderer2.push(`<!----></a> <span${attr("title", `${stringify(roleLabel(user.role))} · ${stringify(user.name)}`)} class="cursor-default text-zinc-400 transition-colors hover:text-zinc-600">`);
    Circle_user($$renderer2, { size: 18, strokeWidth: 1.75 });
    $$renderer2.push(`<!----></span> <form method="POST" action="/logout"><button type="submit" title="Log out" class="text-zinc-400 transition-colors hover:text-rose-600">`);
    Log_out($$renderer2, { size: 18, strokeWidth: 1.75 });
    $$renderer2.push(`<!----></button></form></div> <div class="text-center"><h1 class="text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl">Cakna <span class="text-rose-600">Hub</span></h1> <p class="mx-auto mt-4 max-w-xl text-zinc-500">Welcome back, ${escape_html(user.name.split(" ")[0])}. Choose a partition to continue.</p></div> <div class="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">`);
...
//# sourceMappingURL=_page.svelte.js-CjYc7SXW.js.map
