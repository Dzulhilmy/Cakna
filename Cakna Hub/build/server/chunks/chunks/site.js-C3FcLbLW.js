const PAGE_KEYS = ["home", "about", "setem", "csr"];
const HOME_SECTIONS = [
...
const defaultSiteContent = {
  ...
  hero: {
    ...
    subtext: "One Touch, a Thousand Meanings. HOME's Corporate Social Responsibility (CSR) initiative that supports students, empowers communities, and drives meaningful change.",
    bgImages: [],
    overlay: "medium",
  ...
  about: {
    ...
    quoteSub: "Our mission: to deliver accurate, transparent, and continuous support to HOME families nationwide.",
    quoteBgImages: [],
    quoteOverlay: "medium"
  },
  programs: {
    ...
    subtitle: "Each core drives its own community programs — from welfare and education to environmental sustainability.",
  ...
  impact: {
    ...
    subtitle: "At HOME Cakna, we're committed to supporting students, empowering communities, and driving meaningful change through structured CSR initiatives.",
    stats: [
  ...
  partners: {
    ...
    subtitle: "In collaboration with these institutions, we nurture change through education, care, and sustainability.",
    logos: []
  },
  footer: {
    tagline: "Service: Our Mission, Equation: Our Passion. Building a compassionate community through structured CSR initiatives.",
    phone: "011-2111 0110",
  ...
  aboutPage: {
    ...
    ctaOverlay: "medium",
    whoTitle: "Who Are We?",
    whoBody: "HOME Cakna is the Corporate Social Responsibility (CSR) initiative of HOME, established in 2018. We are dedicated to creating meaningful change by empowering communities through structured, impactful programs that focus on education, well-being, and sustainability.\n\nOur programs are designed to foster inclusivity, strengthen community bonds, and provide opportunities for personal and societal growth. With HOME Cakna, every effort is driven by a vision to uplift and inspire, leaving no one behind.",
    visionTitle: "Our Vision",
    visionText: "To transform communities through HOME's commitment to impactful education, innovative care, and sustainable initiatives — bridging gaps and inspiring growth one step at a time.",
    purposeEyebrow: "Our Purpose",
    purposeTitle: "Driving Impactful Change",
    purposeSubtitle: "Through education, welfare, and sustainable community initiatives — built on strong foundations that create lasting change.",
    purpose: [
      {
    ...
    collabSubtitle: "HOME Cakna is more than just a movement. It is a nationwide collaboration between our HQ team and franchise partners, uniting our strengths to bring lasting change to communities in need.",
    stats: [
      { value: "200+", label: "Franchisees involved" },
      { value: "5,000+", label: "Lives benefited" },
      { value: "300+", label: "CSR programs executed" }
    ],
    testimonial: "Being a HOME franchisee is more than just running a business. It's about giving back to the community. Through HOME Cakna, we get to be part of something bigger — helping students beyond the classroom.",
    testimonialAuthor: "Rithauddin, HOME Sungai Besar",
    ctaHeading: "Bring Hope, Create Smiles",
    ctaText: "Every effort we make brings hope to those in need. Join us as a franchisee and be part of something bigger.",
    ctaLabel: "Join Us",
    ctaHref: "/register"
  },
  setemPage: {
    ...
    subtext: "Bridging math gaps, one student at a time — a specialised workshop that helps students overcome their fear of mathematics.",
    heroBgImages: [],
    heroOverlay: "medium",
    ctaBgImages: [],
    ctaOverlay: "medium",
    ...
    gapSubtitle: "Not every child has the same opportunity to learn and grow. Socioeconomic factors, accessibility, and learning disparities continue to widen the gap. It's time to bridge the divide.",
    gapStats: [
    ...
    whatBody: "SETEM is a specialised workshop designed to help students overcome their fear and struggles with mathematics. Using a personalised, therapeutic approach, SETEM aims to boost students' confidence, improve their understanding, and make learning math enjoyable.",
  ...
  csrPage: {
    ...
    subtext: "Meaningful change starts at the grassroots level. Our dedicated franchisees are changemakers driving positive change in education, environment, social welfare, and sustainability — one step at a time.",
    heroBgImages: [],
    heroOverlay: "medium",
    ctaBgImages: [],
    ctaOverlay: "medium",
...
export { ABOUT_SECTIONS as A, CSR_SECTIONS as C, DEFAULT_CSR_ORDER as D, HOME_SECTIONS as H, PAGE_KEYS as P, SETEM_SECTIONS as S, DEFAULT_SETEM_ORDER as a, DEFAULT_ABOUT_ORDER as b, DEFAULT_HOME_ORDER as c, defaultSiteContent as d };
//# sourceMappingURL=site.js-C3FcLbLW.js.map
