...
<style>
	...
	.search-input-wrap {
		...
		border-radius: 14px;
		background: var(--pg-btn);
		border: 1px solid var(--pg-btn-hover);
	...
	.search-input::placeholder { color: var(--pg-subtle); }
	...
	.clear-btn:hover { color: var(--pg-text-75); }
	...
	.result-query { color: var(--pg-btn-color); font-style: italic; }
