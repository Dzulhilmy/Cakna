...
<svelte:head><title>Cipta akaun · Cakna Hub</title></svelte:head>
...
<div class="page">
	...
	<div class="heading">
		...
		<p>Daftar untuk mengakses Cakna Hub.</p>
	</div>
	...
	<div class="card">
			...
			<label>
				...
				<div class="pw-wrap">
					<input
						...
						autocomplete="new-password"
						placeholder="Ulangi kata laluan anda"
						required
					/>
					<button
						type="button"
		...
		<p class="login">
			Sudah ada akaun? <a href="/auth/login">Log masuk</a>
		</p>
