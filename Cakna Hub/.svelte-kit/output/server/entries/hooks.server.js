import { g as getCurrentUser } from "../chunks/auth.js";
...
const handle = async ({ event, resolve }) => {
  ...
  const needsAuth = needsAdminAuth || path.startsWith("/hub/staff") || path.startsWith("/society") || path.startsWith("/core") || path.startsWith("/notifications");
