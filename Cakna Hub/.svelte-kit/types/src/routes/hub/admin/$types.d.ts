...
type LayoutRouteId = RouteId | "/hub/admin" | "/hub/admin/analytics" | "/hub/admin/calendar" | "/hub/admin/dashboard" | "/hub/admin/funding" | "/hub/admin/media" | "/hub/admin/notifications" | "/hub/admin/notifications/new" | "/hub/admin/programs" | "/hub/admin/site" | "/hub/admin/site/[section]" | "/hub/admin/site/docs" | "/hub/admin/site/docs/[slug]" | "/hub/admin/site/home" | "/hub/admin/users"
type LayoutParams = RouteParams & { section?: string | undefined; slug?: string | undefined }
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/hub/admin/+page.server.js').load>>>>>>;
