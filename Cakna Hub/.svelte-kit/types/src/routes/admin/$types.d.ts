...
type LayoutRouteId = RouteId | "/admin" | "/admin/analytics" | "/admin/calendar" | "/admin/dashboard" | "/admin/funding" | "/admin/media" | "/admin/notifications/new" | "/admin/programs" | "/admin/site" | "/admin/site/[section]" | "/admin/site/docs" | "/admin/users"
